...
add_action("wp_enqueue_scripts", function () {
    ...
    //------Ota yhteyttä page-----
    if (is_page(217)) {
        wp_enqueue_style("calori-contact", get_template_directory_uri() . "/assets/styles/contact.css?v1.1");
    }
    ...
    wp_enqueue_style("calori-style-new", get_template_directory_uri() . "/assets/styles/style.min.css?v.1.47");
    wp_enqueue_script("calori-landing-main", get_template_directory_uri() . "/assets/scripts/main.min.js?v1.4", array(), false, true);

    wp_enqueue_script("calori-main", get_template_directory_uri() . "/assets/scripts/main.js?v1.3", array(), false, true);

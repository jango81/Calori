...
<main id="main">
    ...
    <div class="container">
      <div class="section-wrapper">
        ...
        <div class="how-it-works">
          ...
          <div class="how-it-works_item">
            <img src="<?php echo get_template_directory_uri() ?>/assets/images/tilaa1.png" alt="how1"
              class="how-it-works_item_img" />
          ...
          <div class="how-it-works_item">
            <img src="<?php echo get_template_directory_uri() ?>/assets/images/tilaa2.png" alt="how1"
              class="how-it-works_item_img" />
                ...
                while (have_rows('foods', 'options')):
                  ...
                  <div class="swiper-slide">
                    ...
                    <div id="menuitem<?php echo $a; ?>" class="menupopup" style="display:none;max-width:500px;">
                      ...
                      <img src="<?php the_sub_field('food_photo'); ?>" alt="food">
      ...
      <div class="order__container container">
        <div class="order__content">
          ...
          <p class="section-text mb30">
            Huomaa-lähin toimitus on <span class="nextdate"><?php echo get_field("order_end_day", "option") ?></span>.
            <br>
              ...
              <?php foreach ($products as $product):
                ...
                <div class="order__controls" data-product-id="<?php echo esc_attr($product->get_id()) ?>">
                  <div class="product-wrap">
                    <div class="order__settings">
                      ...
                      if (have_rows("exclusion_of_ingredients", "option")): ?>
                        <fieldset class="order-block">
                          <legend class="order-block__title">Исключить из рациона</legend>
                          ...
                          <?php while (have_rows("exclusion_of_ingredients", "option")):
                            ...
                            <div class="check-box">
                              <input type="checkbox" name="exclusion-ingredients" id="exclusion-ingredients"
                                data-ingredient="<?php echo esc_attr($exclusion_ingredients) ?>" />
                              <label for="exclusion-ingredients"><?php echo esc_html($exclusion_ingredients) ?></label>
                            </div>
                          <?php endwhile; ?>
                        </fieldset>
                      <?php endif ?>
                    ...
                    <div class="order__details">
                      ...
                      foreach ($product_variations as $variant):
                        ...
                        /* $customproce = $variant["_product_variable_barcode"]; */
                        /* $customproce1 = $variant["_product_variable_barcode1"]; */
                  ...
                  <div class="menu-image">
                    <img src="<?php echo get_template_directory_uri() ?>/assets/images/menu-bg.png" alt="">
                  </div>
                </div>
  ...
  <script>
    document.addEventListener('DOMContentLoaded', function () {
      ...
      $("body").on('DOMSubtreeModified', ".woocommerce-Price-amount", function () {
      ...
      <div class="section-wrapper">
        ...
        <div class="advantages">
          ...
          <div class="advantages_item">
            ...
            <div class="advantages_item_text">
              Диетологические эксперты в команде
            </div>
          </div>
          <div class="advantages_item">
          ...
          <div class="advantages_item">
            ...
            <div class="advantages_item_text">
              Приготовлено профессиональными поварами
            </div>
          </div>
          <div class="advantages_item">
          ...
          <div class="advantages_item">
            ...
            <div class="advantages_item_text">
              Доставка с адаптированием под клиента
            </div>
          </div>
        </div>
      </div>

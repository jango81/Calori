...
<head>
    ...
    <script>(function (w, d, s, l, i) {
        ...
        })(window, document, 'script', 'dataLayer', 'GTM-PPR83T29');</script>
...
<body <?php body_class(); ?>>
    ...
    <noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-PPR83T29" height="0" width="0"
                    ...
                    <button class="ham">
                        <svg width="40" height="40" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path fill-rule="evenodd" clip-rule="evenodd"
                                d="M1.73333 13.4C1.53884 13.4 1.35231 13.4773 1.21479 13.6148C1.07726 13.7523 1 13.9388 1 14.1333C1 14.3278 1.07726 14.5144 1.21479 14.6519C1.35231 14.7894 1.53884 14.8667 1.73333 14.8667H19.3333C19.5278 14.8667 19.7144 14.7894 19.8519 14.6519C19.9894 14.5144 20.0667 14.3278 20.0667 14.1333C20.0667 13.9388 19.9894 13.7523 19.8519 13.6148C19.7144 13.4773 19.5278 13.4 19.3333 13.4H1.73333ZM1 20C1 19.8055 1.07726 19.619 1.21479 19.4815C1.35231 19.3439 1.53884 19.2667 1.73333 19.2667H19.3333C19.5278 19.2667 19.7144 19.3439 19.8519 19.4815C19.9894 19.619 20.0667 19.8055 20.0667 20C20.0667 20.1945 19.9894 20.381 19.8519 20.5185C19.7144 20.6561 19.5278 20.7333 19.3333 20.7333H1.73333C1.53884 20.7333 1.35231 20.6561 1.21479 20.5185C1.07726 20.381 1 20.1945 1 20ZM1 25.8667C1 25.6722 1.07726 25.4856 1.21479 25.348C1.35231 25.2106 1.53884 25.1333 1.73333 25.1333H19.3333C19.5278 25.1333 19.7144 25.2106 19.8519 25.348C19.9894 25.4856 20.0667 25.6722 20.0667 25.8667C20.0667 26.0611 19.9894 26.2477 19.8519 26.3853C19.7144 26.5227 19.5278 26.6 19.3333 26.6H1.73333C1.53884 26.6 1.35231 26.5227 1.21479 26.3853C1.07726 26.2477 1 26.0611 1 25.8667Z"
                                fill="#2C2D31" />
                        </svg>
                    </button>
